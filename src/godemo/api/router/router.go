...
import (
    PlayerController "godemo/api/controller"
    LeagueController "godemo/api/controller"
    TournamentController "godemo/api/controller"
    MatchupController "godemo/api/controller"
    GameController "godemo/api/controller"
    jsonResponseFormatter "godemo/api/response"
